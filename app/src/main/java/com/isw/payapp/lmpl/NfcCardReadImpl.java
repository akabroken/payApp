...
public class NfcCardReadImpl {
    ...
    private KimonoRequest kimonoRequest;
    private CardModel cardModel;

    public NfcCardReadImpl(Context context, int iRet, EmvService emvService, PayData payData) {
        ...
        public int onOnlineProcess(EmvOnlineData OnlineData) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    cardModel.setPinBlock(StringUtil.bytesToHexString(param.Pin_Block));
                    cardModel.setKsn(StringUtil.bytesToHexString(param.Curr_KSN).substring(4));
                    cardModel.setKSNTag(StringUtil.bytesToHexString(param.Curr_KSN).substring(4, 10));
    ...
    public String procPayment() {
        try {
            ...
            kimonoRequest = new KimonoRequest(emvTLVExtractor.extractEmvData(), payData, cardModel);
