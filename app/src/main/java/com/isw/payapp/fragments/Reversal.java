...
public class Reversal extends Fragment {
...
Log.i("TEST",auth);
    ...
    private void startBackgroundTask() throws ExecutionException, InterruptedException {
        ...
        payData.setAuthCode(auth);
        payData.setTransCnt(stan);
        payData.setPaymentApp(ConstValues.PAY_APP_REVERSAL);
        payData.setPaymentReqTag(ConstValues.POST_PAY_REVERSAL);
...
//        PaymentProcessor processor = new PaymentProcessor(getActivity(),progressDialog,10,1000, progressLister,payData);
    ...
    private void closeWin() {
        NavHostFragment.findNavController(Reversal.this)
                .navigate(R.id.fragment_reversal_to_transaction);
    }
