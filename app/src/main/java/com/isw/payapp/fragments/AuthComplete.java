...
import com.isw.payapp.databinding.FragmentAuthCompleteBinding;
...
public class AuthComplete extends Fragment {
    ...
    TextView title_tv;
    EditText inputAmt, inputStan, inputAuth;
    Button sale;
    String Amount, stan, auth;
    ...
    private FragmentAuthCompleteBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentAuthCompleteBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        inputStan = binding.ostan.findViewById(R.id.ostan);
        inputAuth = binding.oauth.findViewById(R.id.oauth);
    ...
    private void startBackgroundTask() throws ExecutionException, InterruptedException {
        ...
        payData.setAuthCode(auth);
        payData.setTransCnt(stan);
        payData.setPaymentApp(ConstValues.PAY_APP_COMPLETE);
        payData.setPaymentReqTag(ConstValues.POST_PAY_COMPLETE);
...
//        PaymentProcessor processor = new PaymentProcessor(getActivity(),progressDialog,10,1000, progressLister,payData);
    ...
    private void closeWin() {
        NavHostFragment.findNavController(AuthComplete.this)
                .navigate(R.id.fragment_authcomplete_to_transaction);
    }
