...
//    private PinPadView pinPadView;
    ...
    public BasePinPadView getPayViewPass() {
        return pinPadView;
    }
     ...
     */
    public PinPadDialog setPinPadView(BasePinPadView pinPadView) {
        if (pinPadView == null) {
     ...
     * @return the current PinPadDialog instance for method chaining
     */
    public PinPadDialog setPinPadView(BasePinPadView pinPadView, LinearLayout.LayoutParams layoutParams) {
        if (pinPadView == null) {
            throw new IllegalArgumentException("PinPadView cannot be null");
        }
     ...
     */
    private void initDialogWithCustomView(BasePinPadView customPinPadView) {
        try {
