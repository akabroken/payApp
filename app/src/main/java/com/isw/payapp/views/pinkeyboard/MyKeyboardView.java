...
import com.isw.payapp.utils.ByteArrayUtil;
...
//            }
            ...
            if (code >= 0) {//number value
                ...
                String locationStr = ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(ayRandomKey[index])) + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(x)) + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(y))
                        + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(rit)) + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(riby));
                s.append(locationStr);
                index++;
            } else {
                if (code == -3) {
                    label = ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(13));
                } else if (code == -4) {
                    label = ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(15));
                } else {
                    label = ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(14));
                }
                String locationStr = label + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(x)) + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(y))
                        + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(rit)) + ByteArrayUtil.byteArray2Hex(ByteArrayUtil.intToByteArray(riby));
                s.append(locationStr);
            }
        }
