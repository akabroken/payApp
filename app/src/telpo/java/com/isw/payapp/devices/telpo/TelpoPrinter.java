...
public class TelpoPrinter implements IPrinterProcessor {
...
// Resize the bitmap using Bitmap.createScaledBitmap
            ...
            usbThermalPrinter.addString("CARD NO:" + spaceString + receipt.getCardNumber());
            usbThermalPrinter.addString("TRANS TYPE:        "+receipt.getTransactionType());
           // usbThermalPrinter.addString("RSP CODE:          "+ receipt.getResponse());
            usbThermalPrinter.addString("   "+ receipt.getResponse());
