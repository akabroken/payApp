...
import com.isw.payapp.payments.KmsgRequest;
...
public class PinChangeImpl /*extends EmvServiceListener */{
    ...
    private KmsgRequest getKmsg;
    private String pan;

    public PinChangeImpl(Context context, EmvService emvService, PayData payData, int event) {
...
//
//            try {
////                emvTLVExtractor = new EmvTLVExtractor(emvService, payData.getKimonoData());
////                getKmsg = new KmsgRequest(emvTLVExtractor.extractEmvData(), payData, cardModel);
////                setKimonoData(getKmsg.Payload());
////                payData.setKimonoData(getKmsg.Payload());
